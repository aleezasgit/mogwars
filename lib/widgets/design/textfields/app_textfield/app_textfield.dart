...
class AppTextFieldState extends State<AppTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    if (hasError) {
      activeShadow = [
        BoxShadow(
          color: Color(0x26DF1C41),
          blurRadius: 1,
          spreadRadius: 3,
          offset: const Offset(0, 0),
        ),
        // BoxShadow(
        //   color: const Color(0xFFEC778D),
        //   blurRadius: 0,
        //   spreadRadius: 1,
        //   offset: const Offset(0, 0),
        // ),
      ...
      children: [
        ...
        Container(
          ...
          child: FormBuilderTextField(
            ...
            obscureText: show,
            style: widget.style ?? AppText.b1!.cl(activeTextColor),
            ...
            decoration: InputDecoration(
              ...
              hintStyle: widget.hintStyle ?? AppText.b1!.cl(activeTextColor),
              ...
              fillColor: (widget.fillColor ?? AppTheme.c.background.shade100),
        ...
        if (errorMessage != null) ...[
          Space.yf(6),
          Text(errorMessage, style: AppText.l2!.cl(AppTheme.c.error.main!)),
        ],
